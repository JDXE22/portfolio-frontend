    ...
    <Section id='contact' title={dictionary('sectionTitle')} align='center'>
      ...
      <div className='grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4'>
        ...
        <a
          ...
          className='section-card group p-6 transition-all duration-300 hover:-translate-y-1 hover:border-deep-500/40'>
          <div className='flex flex-col items-center gap-3 text-center'>
            <div className='flex h-14 w-14 items-center justify-center rounded-full bg-deep-800/50 transition-colors group-hover:bg-deep-700/60'>
              <svg
                aria-hidden='true'
                className='h-7 w-7 text-deep-400'
                fill='none'
                viewBox='0 0 24 24'
                stroke='currentColor'>
                <path
        ...
        {/* Discord */}
        <div className='section-card group p-6 transition-all duration-300 hover:-translate-y-1 hover:border-deep-500/40'>
          <div className='flex flex-col items-center gap-3 text-center'>
            <div className='flex h-14 w-14 items-center justify-center rounded-full bg-deep-800/50 transition-colors group-hover:bg-deep-700/60'>
              <svg
                aria-hidden='true'
