...
export default function ContactSection() {
  ...
  return (
    <Section id='contact' title={dictionary('sectionTitle')} align='left'>
      <p className='mb-10 max-w-lg text-sm text-foreground/60'>
        {dictionary('subtitle')}
      </p>
      ...
      <a
        ...
        className='group mb-4 flex w-full items-center justify-between section-card rounded-xl px-6 py-5 transition-all duration-200 hover:-translate-y-0.5 hover:border-malibu-400/40'>
        <div className='flex items-center gap-4'>
          <div className='flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-malibu-700/30 transition-colors group-hover:bg-malibu-600/40'>
            <svg
              aria-hidden='true'
              className='h-5 w-5 text-malibu-400'
              fill='none'
              viewBox='0 0 24 24'
              stroke='currentColor'>
              <path
        ...
        <span
          aria-hidden='true'
          className='text-lg text-malibu-400 opacity-0 transition-opacity group-hover:opacity-100'>
          →
        </span>
      </a>
      ...
      <div className='grid grid-cols-1 gap-3 sm:grid-cols-3'>
        ...
        <a
          ...
          className='group flex items-center gap-3 section-card rounded-xl px-4 py-4 transition-all duration-200 hover:-translate-y-0.5 hover:border-malibu-400/40'>
        ...
        {/* Discord */}
        <div className='group flex items-center gap-3 section-card rounded-xl px-4 py-4'>
