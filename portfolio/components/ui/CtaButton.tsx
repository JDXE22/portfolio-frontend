...
export default function CtaButton({
  ...
  const variants = {
    primary: `bg-malibu-600 text-white hover:bg-malibu-500 hover:-translate-y-0.5 active:translate-y-0`,
    secondary: `bg-transparent border border-malibu-500/50 text-malibu-100 hover:border-malibu-400 hover:bg-malibu-800/15 hover:-translate-y-0.5`,
  };
